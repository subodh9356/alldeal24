        ...
        <>
          ...
          <div className="card-grid">
            {filteredCars.map((car) => (
              <div key={car.id} className="card-hover" style={styles.card}>
                <img src={car.carImages?.[0]} alt={car.carTitle} style={styles.image} />
                <h3 style={styles.cardTitle}>{car.carTitle}</h3>
                <div style={styles.cardLine}><FaMapMarkerAlt style={styles.icon} /> {car.carLocation}</div>
                <div style={styles.cardLine}><FaRupeeSign style={styles.icon} /> ₹{car.carPrice}</div>
